...
# WIP: trying to remove some error cases with lower harmonic frequency (2-chamber problem)  
...
# WIP: Try taking the max of max + limit signals with deviation from median
