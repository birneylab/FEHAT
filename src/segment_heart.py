...
from skimage.filters import threshold_triangle, threshold_yen, threshold_isodata
...
def run(video, args, video_metadata):
    ...
    if not args['slowmode']:
        bpm, nr_peaks, prominence, height, has_low_variance  = fourier_bpm(hroi_pixels, timestamps, empty_frames, 1/fps, args, out_dir)
