...
def parse_arguments():
    ...
    # Cropping Arguments
    parser.add_argument('-s','--embryo_size',action="store",         dest='embryo_size',     help='radius of embryo in pixels',                  default=300,        required = False, type=int)
    parser.add_argument('--crop',           action="store_true",    dest='crop',            help='Should crop images and analyse',                                  required = False)
    parser.add_argument('--crop_and_save',  action="store_true",    dest='crop_and_save',   help='Should crop crop images and save, and run bpm in cropped images', required = False)
    parser.add_argument('--only_crop',      action="store_true",    dest='only_crop',       help='Should only crop images, not run bpm script',                     required = False)
    ...
    parser.set_defaults(crop=False, only_crop=False, crop_and_save=False, slowmode=False, cluster=False, email=False, debug=False)
