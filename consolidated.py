...
if development == True:
    indir='/nfs/research/birney/users/marcio/medaka_images/new_report/MDK_2021-03-28_053709'
    out_dir='/nfs/research/birney/users/marcio/medaka_images/new_report/MDK_2021-03-28_053709'
    loops="LO001.LO002.LO003"
else:

    parser = argparse.ArgumentParser(description='Read in medaka heart video frames')
    parser.add_argument('-o','--out', action="store", dest='out', help='Where store the output report in CSV', default=False, required = True)


    parser.add_argument('-i','--indir', action="store", dest='indir', help='Where the loops folders are folder', default=False, required = True)
